...
class DestriesGenerator extends Command
{
     ...
     * @var string
     */
    protected $signature = 'apitoolz:remove {model} {--table=} {--model} {--force-delete}';
     ...
     * @var string
     */
    protected $description = 'Remove config, model, and table etc.. based on provided model.';
    ...
    public function handle()
    {
        ...
        if($this->option('table') != "") {
            ...
            $this->info("This $table model found.");
        }
